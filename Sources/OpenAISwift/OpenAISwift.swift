...
extension OpenAISwift {
    ...
    public func sendCompletion(with prompt: String,
                               ...
                               logitBias: [Int: Double]? = nil,
                               frequencyPenalty: Double? = nil,
                               stop: [String]? = nil) async throws -> OpenAI<TextResult> {
        return try await withCheckedThrowingContinuation { continuation in
            sendCompletion(with: prompt, model: model, maxTokens: maxTokens, temperature: temperature, logitBias: logitBias, frequencyPenalty: frequencyPenalty, stop: stop) { result in
